...
#if defined(S112)
#define EPD_CFG_52811 {0x14, 0x13, 0x06, 0x05, 0x04, 0x03, 0x02, 0x0E, 0xFF, 0x11, 0x07,MODE_CLOCK}//0x10-red,0x11-green,0x12-blue
//      EPD_CFG_52811 {MOSI, CLK,  CS  , DC  , RST , BUSY, BS  , epd_model_id_t, weakup, LED,  EN, display_mode_t,week_start}
